...
import com.yk.utils.EmailUtils;
...
//        mailReceiver.handler(employee);
    ...
    public Integer deleteEmpByEids(Integer[] ids) {
        oplogService.addOpLog(new OpLog((byte) 9, new Date(), "员工批量离职：name：" +ids , Hruitls.getCurrent().getName()));
    ...
    public Integer updateEmployeeSalaryById(Integer eid, Integer sid) {
        oplogService.addOpLog(new OpLog((byte) 5, new Date(), "员工账套变动：工号：【" + eid + "】账套ID：【" + sid + "】", Hruitls.getCurrent().getName()));
        return employeeMapper.updateEmployeeSalaryById(eid, sid);
    }

    public Integer deleteEmployeeSalaryById(Integer eid){
        oplogService.addOpLog(new OpLog((byte) 5, new Date(), "员工账套变动：工号：【" + eid + "】", Hruitls.getCurrent().getName()));
        return employeeMapper.deleteEmployeeSalaryById(eid);
    }
